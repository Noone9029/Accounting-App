...
- `OFFICIAL_SDK_FIXTURE_VALIDATION_RESULTS.md` records the current official fixture pass; official samples pass under Java 11, while LedgerByte XML fixtures fail and remain non-compliant.
