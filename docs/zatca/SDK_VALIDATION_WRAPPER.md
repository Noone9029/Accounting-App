...
4. Validate API-generated invoice XML with the SDK wrapper after local API/DB fixture generation is available.
5. Compare SDK `-generateHash` output to LedgerByte hash output before changing app hash logic.
