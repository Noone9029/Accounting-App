...
- A 2026-05-20 narrow-phase validation added `smoke:accounting:ar`, `smoke:accounting:ap`, `smoke:accounting:documents`, `smoke:accounting:reports`, and `smoke:accounting:zatca-safe`. AR and AP passed inside their 20-minute ceilings. Documents passed in about 7.3 minutes on API deployment `dpl_8Z4GRKDuCH7cA5segwHDitzFYN3X`, web deployment `dpl_BQh5iwGcWDrKyG2Zcc2ngxq9B4H9`, commit `fe4e879d5d966b6c4aebbeb2bbeb9a9de0b7e126`. Reports failed on `GET /dashboard/summary` after the 60-second request timeout; API/web health stayed HTTP `200`, readiness stayed `ok`, and pool counts stayed stable from `active=1`, `idle=5`, `unknown=8` to `active=1`, `idle=7`, `unknown=8`. ZATCA-safe, full smoke, and full E2E were intentionally deferred by the stop rule.
