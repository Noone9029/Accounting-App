...
- Reporting behavior:
  ...
  - `GET /inventory/purchase-receipt-posting-readiness` returns an advisory readiness audit for future receipt asset posting, including Inventory Asset and Inventory Clearing mappings, blockers, warnings, and a recommended next step. It does not mutate accounting.
