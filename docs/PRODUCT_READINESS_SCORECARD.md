...
| ZATCA | 24 | Profile, EGS, CSR groundwork, mock CSID, local XML/QR/hash, SDK readiness docs, disabled-by-default local SDK validation endpoints, official fixture registry/results doc, blocked real network behavior. | Local fixture execution is blocked by Java 17; no official XML, signing, CSID, clearance, reporting, PDF/A-3, KMS key custody. | Configure Java 11-14, run official SDK fixtures first, then compare generated XML/hash. |
...
4. Java 11-14 setup for official ZATCA SDK fixture validation and generated XML gap closure.
