...
- The manual OTP gate was not merged during this run; this lane is stacked on top of that clean docs/static-guard branch, and PR `#9` now tracks the manual OTP gate base.
...
- Next ZATCA priority: `ZATCA sandbox network request approval gate`.
