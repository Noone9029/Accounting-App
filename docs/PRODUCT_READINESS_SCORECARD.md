...
- This remains manual banking only and does not add live feeds, bank APIs, credentials, payment initiation, full cheque lifecycle, provider abstraction, card expense management, statement-cycle billing, silent posting, silent auto-match, automatic reconciliation, VAT/ZATCA/report changes, hosted/customer-data proof, or production-readiness claims.
...
- Remaining blockers are cheque lifecycle, live feeds/provider abstraction, journal-backed deposit clearing, journal-backed card settlement posting, DB-level fingerprint/index if needed, certified target-bank parser coverage, raw statement archive execution, transfer fees, FX handling, hosted/customer-data proof, broad banking E2E/smoke/full-test coverage, and accountant sign-off.
...
- This remains manual banking only and does not add live feeds, bank APIs, credentials, payment initiation, card settlement, full cheque lifecycle, provider abstraction, silent posting, silent auto-match, automatic reconciliation, VAT/ZATCA/report changes, hosted/customer-data proof, or production-readiness claims.
...
- Remaining blockers are card settlements, full cheque lifecycle, live feeds/provider abstraction, DB-level fingerprint/index if needed, certified target-bank parser coverage, raw statement archive execution, transfer fees, FX handling, hosted/customer-data proof, broad banking E2E/smoke/full-test coverage, and accountant sign-off.
