...
| ZATCA | 36 | Profile, EGS, CSR groundwork, mock CSID, local XML/QR/hash, SDK readiness docs, disabled-by-default local SDK validation endpoints, official fixture registry/results doc, official sample validation pass under Java 11, local standard fixture SDK global pass, simplified fixture XSD/EN/PIH pass, API-generated standard XML local SDK validation, no-mutation SDK/app hash comparison, dry-run hash-chain reset plan, blocked real network behavior. | Signing, Phase 2 QR, CSID, clearance, reporting, PDF/A-3, official hash persistence, generated XML address/identifier warnings, and KMS key custody remain missing. | Implement SDK/C14N11-backed hash persistence after reset policy approval, then design signing/certificate work. |
...
4. LedgerByte ZATCA SDK/C14N11 hash persistence, generated XML warning cleanup, signing/certificate, and Phase 2 QR work.
