...
| Banking/reconciliation | 66 | Bank profiles, transfers, opening balances, statement import, matching, categorization, reconciliation approval/close/void, reports, and visible banking/reconciliation drill-down guidance. | No live feeds, auto-match, OFX/CAMT/MT940 parser, transfer fees, FX handling, production file storage workflow. | Add bank file upload/parser groundwork and approval queue polish. |
