...
| ZATCA | 35 | Profile, EGS, CSR groundwork, mock CSID, local XML/QR/hash, SDK readiness docs, disabled-by-default local SDK validation endpoints, official fixture registry/results doc, official sample validation pass under Java 11, local standard fixture SDK global pass, simplified fixture XSD/EN/PIH pass, API-generated standard XML local SDK validation, read-only SDK/app hash comparison, blocked real network behavior. | Signing, Phase 2 QR, CSID, clearance, reporting, PDF/A-3, app hash-chain replacement, generated XML address/identifier warnings, and KMS key custody remain missing. | Design official hash-chain replacement/reset plan before signing/certificate work. |
...
4. Remaining LedgerByte ZATCA hash-chain replacement, generated XML warning cleanup, signing/certificate, and Phase 2 QR work.
