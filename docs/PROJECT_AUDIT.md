...
- Inventory warehouse, stock ledger, adjustment approval, warehouse transfer controls, manual purchase receiving, manual sales stock issue, valuation settings, purchase bill clearing-mode finalization, inventory clearing preview/matching groundwork, purchase receipt posting readiness audit, manual COGS posting, and operational reports exist, but automatic COGS, purchase receipt inventory asset posting, clearing reconciliation, automatic receipts/issues, landed cost, serial/batch tracking, and accounting-grade inventory financial reports are not implemented.
...
5. Inventory warehouses, adjustment controls, transfers, manual receipts/issues, valuation settings, purchase bill clearing-mode finalization, inventory clearing preview/matching groundwork, purchase receipt posting readiness audit, and manual COGS posting exist, but automatic COGS, purchase receipt inventory asset posting, GL valuation, clearing reconciliation, automatic receipts/issues, landed cost, serial/batch tracking, and accounting-grade inventory financial reports are still missing.
...
7. Add explicit receipt inventory asset posting workflows for compatible inventory-clearing bills, with migration/exclusion rules, reversals, void protection, and variance policy.
