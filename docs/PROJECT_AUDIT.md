...
- Bank feeds, external bank APIs, automatic matching, certified bank-specific OFX/CAMT/MT940 parser coverage, raw statement-file archive policy, transfer fees, and multi-currency FX transfers are not implemented.
...
6. Harden bank reconciliation with real sanitized bank-format variants, broader OFX/CAMT/MT940 parser coverage, optional raw-file archive policy, transfer fees, and multi-currency FX handling.
