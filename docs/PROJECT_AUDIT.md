...
Current commit audited: pending (`Add purchase receiving and sales stock issue groundwork`)
...
5. Inventory warehouses, adjustment controls, transfers, manual receipts/issues, valuation settings, and operational reports exist, but COGS, GL valuation, automatic receipts/issues, landed cost, serial/batch tracking, and accounting-grade inventory financial reports are still missing.
...
7. Add accountant-reviewed inventory asset posting and COGS design for the manual receipt/issue workflows.
