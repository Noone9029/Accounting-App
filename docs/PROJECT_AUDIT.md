...
Current commit audited: pending (`Add bank transfers and opening balance posting`)
...
- Bank account profiles for cash/bank asset accounts, posted transaction visibility, bank-aware payment/expense account labels, posted bank transfers, transfer voids, and guarded one-time opening-balance journals.
...
- Bank statement import, reconciliation, live bank feeds, transfer fees, and multi-currency FX transfers are not implemented.
...
4. Bank account profiles and transfers exist, but no bank reconciliation or bank statement import.
...
6. Add bank statement import, reconciliation, transfer fees, and multi-currency FX handling.
