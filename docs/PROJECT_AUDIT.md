...
- Inventory warehouse, stock ledger, adjustment approval, warehouse transfer controls, manual purchase receiving, manual sales stock issue, valuation settings, preview-only accounting settings, and operational reports exist, but automatic COGS, inventory asset posting, inventory clearing, automatic receipts/issues, landed cost, serial/batch tracking, and accounting-grade inventory financial reports are not implemented.
...
5. Inventory warehouses, adjustment controls, transfers, manual receipts/issues, valuation settings, and preview-only accounting panels exist, but real COGS, GL valuation, inventory clearing, automatic receipts/issues, landed cost, serial/batch tracking, and accounting-grade inventory financial reports are still missing.
...
7. Finalize accountant-reviewed inventory clearing and explicit COGS/inventory asset posting workflows after reviewing the new preview layer.
