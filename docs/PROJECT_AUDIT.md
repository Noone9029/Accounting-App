...
- Inventory warehouse, stock ledger, adjustment approval, warehouse transfer controls, manual purchase receiving, manual sales stock issue, valuation settings, manual COGS posting, and operational reports exist, but automatic COGS, purchase receipt inventory asset posting, inventory clearing, automatic receipts/issues, landed cost, serial/batch tracking, and accounting-grade inventory financial reports are not implemented.
...
5. Inventory warehouses, adjustment controls, transfers, manual receipts/issues, valuation settings, and manual COGS posting exist, but automatic COGS, purchase receipt inventory asset posting, GL valuation, inventory clearing, automatic receipts/issues, landed cost, serial/batch tracking, and accounting-grade inventory financial reports are still missing.
...
7. Finalize accountant-reviewed inventory clearing and explicit purchase receipt inventory asset posting workflows after reviewing manual COGS behavior.
