...
- Remaining UAE blockers: official-code TODO review, actual provider responses, sandbox docs, provider payload samples, commercial terms, SaaS/ISV permission, security/data residency answers, legal/accountant review, hosted/customer-data proof, and broad coverage before any production claim.
