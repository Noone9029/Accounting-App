...
- Remaining Wafeq banking route: inline statement transaction review workspace, import duplicate/idempotency/reconciliation safety hardening, bank rules, bank deposit batches, card settlement flows, cheque lifecycle, bank-feed abstraction, and Lean/WIO/Tarabut sandbox integration later.
