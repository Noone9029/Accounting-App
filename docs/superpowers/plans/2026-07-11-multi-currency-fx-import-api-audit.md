...
- [ ] Run Prisma generate/validate, full API/web/package tests, API/web/workspace typechecks, full build, focused browser import review, diff check, and high-risk secret scan.
