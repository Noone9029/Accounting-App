...
- Full deployed E2E remained intentionally deferred after the 2026-05-20 journal-route, banking-route, and monolithic full-smoke-duration isolation. Run bounded deployed smoke phases, including `smoke:accounting:tail`, before attempting full deployed E2E.
