...
- Full deployed E2E remained intentionally deferred after the 2026-05-20 journal-route, banking-route, monolithic full-smoke-duration isolation, and first tail-slice ceiling result. Split and pass the remaining deployed smoke tail phases before attempting full deployed E2E.
