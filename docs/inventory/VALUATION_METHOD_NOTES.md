...
- Inventory clearing settings, previews, and explicit clearing-mode purchase bill journals exist, but purchase receipt inventory asset posting and clearing reconciliation are not implemented.
