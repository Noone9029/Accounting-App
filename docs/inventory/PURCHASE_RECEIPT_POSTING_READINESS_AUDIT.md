...
5. Add receipt GL reversal and block receipt void while receipt GL is active.
6. Add purchase bill clearing design and migration strategy.
...
- [ ] Purchase bill posting has a compatible clearing strategy.
