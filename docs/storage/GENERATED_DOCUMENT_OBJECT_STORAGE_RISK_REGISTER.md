...
| Object storage enabled before DB fallback proof | Current generated documents could become unreadable if object reads fail | Implementation plan requires DB-backed default, disabled object reads, and fallback-first rollout | Runtime adapter does not exist | DB adapter compatibility tests and staged object-read proof |
