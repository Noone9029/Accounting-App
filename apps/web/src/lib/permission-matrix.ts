...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [
      ...
      permission(PERMISSIONS.recurringTransactions.read, "View recurring transactions", "Review recurring templates, schedules, run history, blockers, and generated draft links."),
      permission(PERMISSIONS.recurringTransactions.manage, "Manage recurring transactions", "Create, edit, activate, pause, resume, and archive recurring templates."),
      permission(PERMISSIONS.recurringTransactions.run, "Run recurring transactions", "Request idempotent draft generation without posting accounting or moving money."),
      permission(PERMISSIONS.recurringTransactions.review, "Review recurring expense proposals", "Explicitly turn a validated recurring expense proposal into a normal expense workflow."),
      ...
      permission(PERMISSIONS.accountingClose.read, "View close workspace", "See accountant month-end close cycles, readiness, tasks, and safe evidence references."),
      permission(PERMISSIONS.accountingClose.manage, "Manage close workspace", "Start close cycles, refresh readiness, and manage manual close tasks and evidence."),
      permission(PERMISSIONS.accountingClose.prepare, "Prepare close cycles", "Record preparer sign-off after required close work is complete."),
      permission(PERMISSIONS.accountingClose.review, "Review close cycles", "Record reviewer sign-off for a frozen close-readiness snapshot."),
      permission(PERMISSIONS.accountingClose.close, "Close fiscal periods through close workspace", "Request the authoritative fiscal-period close transition after final revalidation."),
      permission(PERMISSIONS.accountingClose.lock, "Lock fiscal periods through close workspace", "Request the final authoritative fiscal-period lock transition after revalidation."),
      ...
      permission(PERMISSIONS.contacts.sendCustomerStatements, "Send customer statements", "Queue customer statement PDFs for local/mock email delivery."),
      permission(PERMISSIONS.contacts.sendSupplierStatements, "Send supplier statements", "Queue supplier statement PDFs for local/mock email delivery."),
      ...
      permission(PERMISSIONS.fixedAssets.read, "View fixed assets", "See the tenant fixed-asset register, schedules, movements, and reports."),
      permission(PERMISSIONS.fixedAssets.manage, "Manage fixed assets", "Create, update, and review fixed-asset drafts."),
      permission(PERMISSIONS.fixedAssets.categoriesManage, "Manage fixed-asset categories", "Configure fixed-asset account mappings and category defaults."),
      permission(PERMISSIONS.fixedAssets.capitalize, "Capitalize fixed assets", "Post reviewed manual or purchase-bill-line capitalization."),
      permission(PERMISSIONS.fixedAssets.depreciationReview, "Review depreciation", "Preview and review monthly depreciation runs."),
      permission(PERMISSIONS.fixedAssets.depreciationPost, "Post depreciation", "Post or reverse reviewed depreciation runs."),
      permission(PERMISSIONS.fixedAssets.dispose, "Dispose fixed assets", "Post disposal, write-off, and eligible reversal workflows."),
      permission(PERMISSIONS.fixedAssets.reports, "View fixed-asset reports", "Open register, depreciation, disposal, and GL reconciliation reports."),
    ],
  },
  {
    id: "inventory",
  ...
  },
  {
    ...
    permissions: [
      ...
      permission(PERMISSIONS.customerPayments.send, "Send payment receipts", "Queue posted customer payment receipt PDFs for local/mock email delivery."),
      ...
      permission(PERMISSIONS.creditNotes.send, "Send credit notes", "Queue finalized customer credit-note PDFs for local/mock email delivery."),
  ...
  },
  {
    ...
    permissions: [
      ...
      permission(PERMISSIONS.purchaseOrders.send, "Send purchase orders", "Queue approved or sent purchase-order PDFs for local/mock email delivery."),
      ...
      permission(PERMISSIONS.supplierPayments.send, "Send supplier remittances", "Queue posted supplier-payment remittance PDFs for local/mock email delivery."),
      ...
      permission(PERMISSIONS.purchaseDebitNotes.send, "Send debit notes", "Queue finalized purchase debit-note PDFs for local/mock email delivery."),
