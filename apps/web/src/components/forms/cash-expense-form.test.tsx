...
describe("CashExpenseForm", () => {
  beforeEach(() => {
    ...
    apiRequestMock.mockImplementation((path: string) => {
      ...
      if (path === "/accounts") {
        return Promise.resolve([
          { id: "cash-1", code: "1110", name: "Cash on hand", type: "ASSET", isActive: true, allowPosting: true },
          { id: "expense-1", code: "5100", name: "Office expenses", type: "EXPENSE", isActive: true, allowPosting: true },
        ]);
      }
      if (path === "/tax-rates") {
      ...
      if (path === "/bank-accounts") {
        return Promise.resolve([{ id: "bank-profile-1", accountId: "cash-1", displayName: "Main cash" }]);
      }
