  ...
  return (
    <section>
      <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-ink">{tc("Edit recurring invoice template")}</h1>
          <p className="mt-1 max-w-3xl text-sm leading-6 text-steel">{tc("Update draft recurring details before activation.")}</p>
        </div>
      ...
      <div className="space-y-3">
        {!organizationId ? <StatusMessage type="info">{tc("Log in and select an organization to edit this recurring invoice template.")}</StatusMessage> : null}
