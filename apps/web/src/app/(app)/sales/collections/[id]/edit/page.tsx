  ...
  return (
    <section>
      <div className="mb-6 flex flex-col gap-3 md:flex-row md:items-start md:justify-between">
        <div>
          <h1 className="text-2xl font-semibold text-ink">Edit collection case</h1>
          <p className="mt-1 max-w-3xl text-sm leading-6 text-steel">
            Update collection follow-up metadata without changing invoice balances, payment allocations, VAT, ZATCA, or email state.
          </p>
        </div>
      ...
      <div className="space-y-3">
        {!organizationId ? <StatusMessage type="info">Log in and select an organization to edit this collection case.</StatusMessage> : null}
