...
export default function AccountingCloseCyclePage() {
  ...
  useEffect(() => {
    ...
    setCycle(null); setTasks([]); setSnapshots([]); setSnapshotMeta(null); setSelectedSnapshot(null); setSnapshotDetail(null); setSnapshotLoading(false); setSnapshotPageLoading(false); setError(""); setRunning(null); setEvidenceLabel(""); setEvidenceTaskId("");
  ...
  async function load() {
    ...
    snapshotRequestId.current += 1;
    setLoading(true); setError(""); setCycle(null); setTasks([]); setSnapshots([]); setSnapshotMeta(null); setSelectedSnapshot(null); setSnapshotDetail(null); setSnapshotLoading(false); setSnapshotPageLoading(false);
    try {
  ...
  async function loadSnapshotPage(page: number) {
    ...
    setSnapshotPageLoading(true); setSelectedSnapshot(null); setSnapshotDetail(null); setSnapshotLoading(false); setError("");
    try {
