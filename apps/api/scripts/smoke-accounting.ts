...
async function main(): Promise<void> {
  ...
  assertEqual(submissionsAfterImmutablePolicyPlan.length, submissionsBeforeImmutablePolicyPlan.length, "ZATCA immutable policy plan does not create submission logs");
