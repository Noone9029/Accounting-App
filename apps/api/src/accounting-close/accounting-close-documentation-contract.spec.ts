...
const contracts = [
  ...
  },
  {
    ...
    phrases: [
      ...
      "cannot be manually completed", "default to `WARNING`", "Manual draft journals", "Draft sales invoices", "Draft credit notes", "Unapplied customer payments", "Draft purchase bills", "scheduled local date", "fail closed",
    ],
  },
  {
