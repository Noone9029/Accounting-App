...
const contracts = [
  ...
  },
  {
    ...
    phrases: [
      ...
      "cannot be manually completed", "default to `WARNING`", "Manual draft journals", "Draft sales invoices", "Draft credit notes", "Unapplied customer payments", "Draft purchase bills", "Draft purchase debit notes", "Unapplied supplier payments", "Unreconciled bank statement transactions", "Incomplete bank reconciliations", "Draft inventory adjustments", "Inventory variance proposals awaiting posting", "scheduled local date", "fail closed",
    ],
  },
  {
