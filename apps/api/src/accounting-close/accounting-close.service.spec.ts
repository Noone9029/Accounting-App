...
import { CreditNoteStatus, CustomerPaymentStatus, FiscalPeriodStatus, JournalEntryStatus, PurchaseBillStatus, PurchaseDebitNoteStatus, SalesInvoiceStatus } from "@prisma/client";
