...
const ownerRoutes = [
  ...
  { slug: "customer-refunds-list", path: "/sales/customer-refunds", heading: /Customer refunds/i, expectedText: /CREF-VIS-001|Credit note|Manual refunds/i, requiredAny: [PERMISSIONS.customerRefunds.view], expectedAction: /Record refund/i },
  ...
  { slug: "customer-refund-detail", path: "/sales/customer-refunds/customer-refund-1", heading: /CREF-VIS-001/i, expectedText: /Refund source|No payment gateway|PDF amount/i, requiredAny: [PERMISSIONS.customerRefunds.view] },
  ...
  { slug: "supplier-refunds-list", path: "/purchases/supplier-refunds", heading: /Supplier refunds/i, expectedText: /SREF-VIS-001|Purchase debit note|Manual refunds/i, requiredAny: [PERMISSIONS.supplierRefunds.view], expectedAction: /Record refund/i },
  ...
  { slug: "supplier-refund-detail", path: "/purchases/supplier-refunds/supplier-refund-1", heading: /SREF-VIS-001/i, expectedText: /Refund source|No bank transfer|PDF amount/i, requiredAny: [PERMISSIONS.supplierRefunds.view] },
