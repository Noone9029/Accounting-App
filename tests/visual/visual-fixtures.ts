...
export const visualAccountingCloseIds = {
  fiscalPeriod: "6b5493af-0a90-4e73-88ae-3f1bc05a0101",
  cycle: "6b5493af-0a90-4e73-88ae-3f1bc05a0102",
  reviewedSnapshot: "6b5493af-0a90-4e73-88ae-3f1bc05a0103",
  baselineSnapshot: "6b5493af-0a90-4e73-88ae-3f1bc05a0104",
} as const;
export const visualAccountingCloseHashes = {
  reviewed: "a2528430a182436351c5152466379eaa8917d16cb75c045b62234764eadd4dd7",
  baseline: "1edaa09d5f42e2e2b7104d9818b5afe9cadaeb6f71c211d60d7d8a817e4568c7",
} as const;
...
const accountingClosePeriod = {
  id: visualAccountingCloseIds.fiscalPeriod,
...
const accountingCloseCycle = {
  id: visualAccountingCloseIds.cycle,
  organizationId: org.id,
  fiscalPeriodId: accountingClosePeriod.id,
  status: "REVIEWED",
  version: 7,
  readinessHash: visualAccountingCloseHashes.reviewed,
  fiscalPeriod: accountingClosePeriod,
  taskCount: 2,
  evidenceCount: 2,
  snapshotCount: 2,
  lastRefreshedAt: "2026-06-30T16:00:00.000Z",
};

const accountingCloseTasks = [
  {
    id: "close-task-bank",
    organizationId: org.id,
    accountingCloseCycleId: accountingCloseCycle.id,
  ...
  {
    id: "close-task-reports",
    organizationId: org.id,
    accountingCloseCycleId: accountingCloseCycle.id,
    title: "Verify financial reports",
    source: "SYSTEM",
...
const accountingCloseSnapshots = [
  {
    id: visualAccountingCloseIds.reviewedSnapshot,
    status: "REVIEWED",
    capturedAt: "2026-06-30T16:00:00.000Z",
    blockerCount: 0,
    warningCount: 1,
    informationCount: 1,
    checkCount: 3,
    canonicalHash: visualAccountingCloseHashes.reviewed,
    sourceVersion: 7,
  },
  {
    id: visualAccountingCloseIds.baselineSnapshot,
    status: "DRAFT",
    ...
    informationCount: 1,
    checkCount: 3,
    canonicalHash: visualAccountingCloseHashes.baseline,
    sourceVersion: 6,
  },
];

const accountingCloseSnapshotDetails = {
  [visualAccountingCloseIds.reviewedSnapshot]: {
    ...accountingCloseSnapshots[0],
    items: [
      {
        checkKey: "fiscal-period-integrity",
        severity: "INFORMATION",
        status: "READY",
        code: "FISCAL_PERIOD_OPEN",
        safeMessage: "The fiscal period remains open for the reviewed close workflow.",
        count: null,
        currencyCode: null,
        sourceUpdatedAt: "2026-06-30T15:55:00.000Z",
        metadataSafe: { title: "Fiscal period integrity" },
      },
      {
        checkKey: "bank-reconciliation",
        severity: "WARNING",
        status: "READY",
        code: "BANK_RECONCILIATIONS_REVIEWED",
        safeMessage: "All bank reconciliations were reviewed before close sign-off.",
        count: 0,
        currencyCode: null,
        sourceUpdatedAt: "2026-06-30T15:58:00.000Z",
        metadataSafe: { title: "Bank reconciliation review" },
      },
      {
        checkKey: "financial-reports",
        severity: "INFORMATION",
        status: "READY",
        code: "FINANCIAL_REPORTS_REVIEWED",
        safeMessage: "Required financial reports were linked as safe close evidence.",
        count: 2,
        currencyCode: null,
        sourceUpdatedAt: "2026-06-30T15:59:00.000Z",
        metadataSafe: { title: "Financial report evidence" },
      },
    ],
  },
  [visualAccountingCloseIds.baselineSnapshot]: {
    ...accountingCloseSnapshots[1],
    items: [
      {
        checkKey: "fiscal-period-integrity",
        severity: "INFORMATION",
        status: "READY",
        code: "FISCAL_PERIOD_OPEN",
        safeMessage: "The fiscal period remains open for the close workflow.",
        count: null,
        currencyCode: null,
        sourceUpdatedAt: "2026-06-30T08:55:00.000Z",
        metadataSafe: { title: "Fiscal period integrity" },
      },
      {
        checkKey: "bank-reconciliation",
        severity: "WARNING",
        status: "WARNING",
        code: "BANK_RECONCILIATIONS_PENDING",
        safeMessage: "One bank reconciliation was awaiting review.",
        count: 1,
        currencyCode: null,
        sourceUpdatedAt: "2026-06-30T08:58:00.000Z",
        metadataSafe: { title: "Bank reconciliation review" },
      },
      {
        checkKey: "financial-reports",
        ...
        count: 2,
        currencyCode: null,
        sourceUpdatedAt: "2026-06-30T08:59:00.000Z",
        metadataSafe: { title: "Financial report evidence" },
      },
    ],
  },
...
const salesQuote = {
  id: "quote-1",
  organizationId: org.id,
  quoteNumber: "QUO-VIS-001",
  customerId: customer.id,
  branchId: null,
  status: "ACCEPTED",
  issueDate: "2026-05-20T00:00:00.000Z",
  expiryDate: "2026-06-20T00:00:00.000Z",
  reference: "RFQ-VIS-001",
  currency: "SAR",
  taxMode: "TAX_EXCLUSIVE",
  subtotal: "125.0000",
  discountTotal: "0.0000",
  taxableTotal: "125.0000",
  taxTotal: "18.7500",
  total: "143.7500",
  notes: "Visual sales quote.",
  ...
  lines: [
    {
      ...
      quoteId: "quote-1",
      itemId: item.id,
      description: "Stable quote item",
      accountId: "sales-account-1",
      quantity: "1.0000",
      unitPrice: "125.0000",
      discountRate: "0.0000",
      taxRateId: "tax-1",
      lineGrossAmount: "125.0000",
      discountAmount: "0.0000",
      taxableAmount: "125.0000",
      taxAmount: "18.7500",
      lineSubtotal: "125.0000",
      lineTotal: "143.7500",
      sortOrder: 0,
      item,
      account: { id: "sales-account-1", code: "4010", name: "Sales", type: "REVENUE", allowPosting: true, isActive: true },
      taxRate: { id: "tax-1", name: "VAT 15%", rate: "15.0000", scope: "BOTH", category: "STANDARD", isActive: true },
    },
  ],
};
...
const recurringInvoiceTemplate = {
  ...
  lastRunDate: "2026-05-15T00:00:00.000Z",
  frequency: "MONTHLY",
  interval: 1,
  dayOfMonth: 15,
  dayOfWeek: null,
  ...
  taxTotal: "150.0000",
  total: "1150.0000",
  notes: "Visual recurring invoice template.",
  terms: "Net 15.",
  customer,
  branch: null,
  lines: [
    {
      id: "recurring-template-line-1",
      organizationId: org.id,
      templateId: "recurring-template-1",
      itemId: item.id,
...
const deliveryNote = {
  id: "delivery-note-1",
  organizationId: org.id,
  deliveryNoteNumber: "DN-VIS-001",
  customerId: customer.id,
  branchId: null,
  status: "ISSUED",
  issueDate: "2026-05-21T00:00:00.000Z",
  deliveryDate: "2026-05-23T00:00:00.000Z",
  reference: salesQuote.quoteNumber,
  relatedSalesInvoiceId: null,
  relatedSalesQuoteId: salesQuote.id,
  relatedSalesStockIssueId: null,
  deliveryAddress: "Warehouse Dock 1",
  notes: "Visual delivery note.",
  instructions: "Deliver during business hours.",
  issuedAt: fixedVisualDate,
  deliveredAt: null,
  cancelledAt: null,
  voidedAt: null,
  customer,
  ...
  relatedSalesQuote: { id: salesQuote.id, quoteNumber: salesQuote.quoteNumber, status: salesQuote.status, issueDate: salesQuote.issueDate, total: salesQuote.total },
  ...
  lines: [
    {
      ...
      organizationId: org.id,
      deliveryNoteId: "delivery-note-1",
      itemId: item.id,
      description: "Stable quote item",
      quantity: "1.0000",
      unitOfMeasure: "each",
      sourceSalesInvoiceLineId: null,
      sourceSalesQuoteLineId: "quote-line-1",
...
const salesInventoryReturn = {
  id: "inventory-return-1",
  organizationId: org.id,
  customerId: customer.id,
  salesReturnNumber: "SRN-VIS-001",
  status: "APPROVED",
  returnDate: "2026-05-24T00:00:00.000Z",
  reason: "Visual return reason",
  reference: "RMA-VIS-001",
  sourceSalesInvoiceId: null,
  sourceCreditNoteId: null,
  sourceDeliveryNoteId: null,
  sourceSalesStockIssueId: null,
  notes: "Visual sales inventory return.",
  ...
  lines: [
    {
      id: "inventory-return-line-1",
      organizationId: org.id,
      salesInventoryReturnId: "inventory-return-1",
      itemId: item.id,
      description: "Returned visual stock item",
      quantity: "2.0000",
      sourceSalesInvoiceLineId: null,
...
const generatedDocuments = [
  {
    id: "generated-document-sales-invoice-long-evidence",
    organizationId: org.id,
    documentType: "SALES_INVOICE",
    sourceType: "SalesInvoice",
    sourceId: "invoice-1",
    documentNumber: "INV-PDF-LOCAL-READY-0000000001",
    filename: "tax-invoice-local-ready-review-copy-with-long-customer-legal-name-and-storage-metadata.pdf",
    mimeType: "application/pdf",
    sizeBytes: 12184,
    status: "GENERATED",
    storageProvider: "DATABASE",
    storageKey: null,
    contentHash: "visual-hash-sales-invoice-local-ready",
  ...
  {
    id: "generated-document-credit-note-local-ready",
    organizationId: org.id,
    documentType: "CREDIT_NOTE",
    sourceType: "CreditNote",
    sourceId: "credit-note-1",
    documentNumber: "CN-PDF-LOCAL-READY-0000000001",
    filename: "credit-note-local-ready-archive-review-with-hash-metadata.pdf",
    mimeType: "application/pdf",
    sizeBytes: 6784,
    status: "GENERATED",
    storageProvider: "DATABASE",
    storageKey: null,
    contentHash: "visual-hash-credit-note-local-ready",
    generatedById: "user-1",
    generatedAt: fixedVisualDate,
    createdById: "user-1",
    createdAt: fixedVisualDate,
  ...
  {
    id: "generated-document-purchase-bill-local-ready",
    organizationId: org.id,
    documentType: "PURCHASE_BILL",
    sourceType: "PurchaseBill",
    sourceId: "bill-1",
    documentNumber: "BILL-PDF-LOCAL-READY-0000000001",
    filename: "supplier-bill-local-ready-review-copy-with-long-supplier-legal-name-and-storage-metadata.pdf",
    mimeType: "application/pdf",
    sizeBytes: 11336,
    status: "GENERATED",
    storageProvider: "DATABASE",
    storageKey: null,
    contentHash: "visual-hash-purchase-bill-local-ready",
    generatedById: "user-1",
    generatedAt: fixedVisualDate,
    createdById: "user-1",
    createdAt: fixedVisualDate,
  ...
  {
    id: "generated-document-debit-note-local-ready",
    organizationId: org.id,
    documentType: "PURCHASE_DEBIT_NOTE",
    sourceType: "PurchaseDebitNote",
    sourceId: "debit-note-1",
    documentNumber: "PDN-PDF-LOCAL-READY-0000000001",
    filename: "purchase-debit-note-local-ready-archive-review-with-ap-adjustment-metadata.pdf",
    mimeType: "application/pdf",
    sizeBytes: 7024,
    status: "GENERATED",
    storageProvider: "DATABASE",
    storageKey: null,
    contentHash: "visual-hash-purchase-debit-note-local-ready",
    generatedById: "user-1",
    generatedAt: fixedVisualDate,
    createdById: "user-1",
    createdAt: fixedVisualDate,
  ...
  {
    id: "generated-document-superseded-invoice",
    organizationId: org.id,
    documentType: "SALES_INVOICE",
    sourceType: "SalesInvoice",
    sourceId: "invoice-1",
    documentNumber: "INV-PDF-SUPERSEDED-0000000001",
    filename: "superseded-invoice-output-kept-for-local-archive-layout-review.pdf",
    mimeType: "application/pdf",
    sizeBytes: 11840,
    status: "SUPERSEDED",
    storageProvider: "DATABASE",
    storageKey: null,
    contentHash: "visual-hash-sales-invoice-superseded",
    generatedById: "user-1",
    generatedAt: fixedVisualDate,
    createdById: "user-1",
    createdAt: fixedVisualDate,
...
function visualApiResponse(pathname: string, searchParams: URLSearchParams, roleProfile: VisualRoleProfileName): MockResponse | null {
  ...
  if (pathname === "/fiscal-periods") {
    return json([accountingClosePeriod]);
  }
  if (pathname === "/accounting-close/readiness") {
    return json({
      blockerCount: 0,
      warningCount: 1,
      informationCount: 1,
      checks: [
        {
          key: "fiscal-period-integrity",
          title: "Fiscal period integrity",
          severity: "INFORMATION",
          status: "READY",
          safeMessage: "The fiscal period remains open for the reviewed close workflow.",
        },
        {
          ...
          status: "READY",
          safeMessage: "All bank reconciliations were reviewed before close sign-off.",
          detailsHref: "/bank-accounts/bank-1/reconciliation",
        },
        {
          key: "financial-reports",
          title: "Financial report evidence",
          severity: "INFORMATION",
          status: "READY",
          safeMessage: "Required financial reports were linked as safe close evidence.",
          detailsHref: "/reports/trial-balance",
        },
      ],
    });
  }
  if (pathname === "/accounting-close/cycles") {
    return json(searchParams.get("fiscalPeriodId") === accountingClosePeriod.id ? accountingCloseCycle : null);
  }
  if (pathname === `/accounting-close/cycles/${accountingCloseCycle.id}`) {
    return json(accountingCloseCycle);
  }
  if (pathname === `/accounting-close/cycles/${accountingCloseCycle.id}/tasks`) {
    return json({ items: accountingCloseTasks, meta: { totalItems: accountingCloseTasks.length } });
  }
  if (pathname === `/accounting-close/cycles/${accountingCloseCycle.id}/snapshots`) {
    const page = Number(searchParams.get("page") ?? "1");
    const pageSize = Number(searchParams.get("pageSize") ?? accountingCloseSnapshots.length);
    return json({
      items: accountingCloseSnapshots,
      meta: { page, pageSize, totalItems: accountingCloseSnapshots.length, totalPages: 1 },
    });
  }
  const accountingCloseComparisonMatch = pathname.match(/^\/accounting-close\/cycles\/([^/]+)\/snapshots\/([^/]+)\/compare$/);
  if (accountingCloseComparisonMatch && accountingCloseComparisonMatch[1] === accountingCloseCycle.id && accountingCloseComparisonMatch[2] === visualAccountingCloseIds.reviewedSnapshot && searchParams.get("baselineSnapshotId") === visualAccountingCloseIds.baselineSnapshot) {
    return json({
      changeCount: 1,
      changes: [
        {
          checkKey: "bank-reconciliation",
          changeType: "MODIFIED",
          before: { safeMessage: "One bank reconciliation was awaiting review." },
          after: { safeMessage: "All bank reconciliations were reviewed before close sign-off." },
        },
      ],
    });
  }
  const accountingCloseSnapshotMatch = pathname.match(/^\/accounting-close\/cycles\/([^/]+)\/snapshots\/([^/]+)$/);
  if (accountingCloseSnapshotMatch && accountingCloseSnapshotMatch[1] === accountingCloseCycle.id) {
    const snapshot = accountingCloseSnapshotDetails[accountingCloseSnapshotMatch[2] as keyof typeof accountingCloseSnapshotDetails];
  ...
  if (pathname === "/sales-quotes/next-number") {
    return json({
      quoteNumber: "QUO-VIS-002",
      editable: false,
      overrideAllowed: false,
      helperText: "Preview only. The quote number is assigned from the sales quote sequence when the draft is saved.",
    });
  }
  if (pathname === "/sales-quotes/quote-1") {
    return json(salesQuote);
  }
  if (pathname === "/sales-quotes") {
    return json([salesQuote]);
  }
  if (pathname === "/recurring-invoices/next-number") {
    return json({
      templateNumber: "RINV-VIS-002",
      editable: false,
      overrideAllowed: false,
  ...
  if (pathname === "/recurring-invoices/recurring-template-1/preview") {
    return json({
      templateId: recurringInvoiceTemplate.id,
      templateNumber: recurringInvoiceTemplate.templateNumber,
      status: recurringInvoiceTemplate.status,
      nextInvoiceDate: recurringInvoiceTemplate.nextRunDate,
      dueDate: "2026-06-30T00:00:00.000Z",
      periodCovered: { startDate: "2026-06-15T00:00:00.000Z", endDate: "2026-07-14T00:00:00.000Z" },
      customer,
      taxMode: recurringInvoiceTemplate.taxMode,
      subtotal: recurringInvoiceTemplate.subtotal,
      discountTotal: recurringInvoiceTemplate.discountTotal,
      taxableTotal: recurringInvoiceTemplate.taxableTotal,
      taxTotal: recurringInvoiceTemplate.taxTotal,
      total: recurringInvoiceTemplate.total,
      lines: recurringInvoiceTemplate.lines,
      nextOccurrences: ["2026-06-15T00:00:00.000Z", "2026-07-15T00:00:00.000Z", "2026-08-15T00:00:00.000Z"],
      blockers: [],
      previewOnly: true,
    });
  }
  if (pathname === "/recurring-invoices/recurring-template-1") {
    return json(recurringInvoiceTemplate);
  }
  if (pathname === "/recurring-invoices") {
    return json([recurringInvoiceTemplate]);
  }
  if (pathname === "/delivery-notes/next-number") {
    return json({
      deliveryNoteNumber: "DN-VIS-002",
      editable: false,
      overrideAllowed: false,
      helperText: "Preview only. The delivery note number is assigned from the delivery note sequence when saved.",
    });
  }
  if (pathname === "/delivery-notes/delivery-note-1") {
    return json(deliveryNote);
  }
  if (pathname === "/delivery-notes") {
    return json([deliveryNote]);
  }
  if (pathname === "/sales-inventory-returns/next-number") {
    return json({
      salesReturnNumber: "SRN-VIS-002",
      helperText: "Assigned from the sales inventory return sequence when saved.",
    });
  }
  if (pathname === "/sales-inventory-returns/inventory-return-1/inventory-return-preview") {
    return json({
      readOnly: true,
      previewOnly: true,
      ...
      sourceSalesInventoryReturn: { id: salesInventoryReturn.id, salesReturnNumber: salesInventoryReturn.salesReturnNumber, status: salesInventoryReturn.status },
      ...
      lines: [
        {
          lineId: "inventory-return-line-1",
          description: "Returned visual stock item",
          item,
          warehouse,
          returnQuantity: "2.0000",
          currentOnHand: "15.0000",
          projectedOnHandAfterReturn: "17.0000",
  ...
  if (pathname === "/sales-inventory-returns/inventory-return-1") {
    return json(salesInventoryReturn);
  }
  if (pathname === "/sales-inventory-returns") {
    return json([salesInventoryReturn]);
  }
  if (pathname === "/sales-stock-issues") {
    return json([]);
  }
  ...
  if (pathname === "/system/backup-evidence") {
    return json({
      ...
      evidence: backupEvidenceRecords(),
    });
  }
...
function backupEvidenceRecords() {
  return [
    backupEvidenceRecord({
      id: "backup-evidence-db-draft",
      evidenceType: "DATABASE_BACKUP",
      status: "DRAFT",
      provider: "local metadata runbook",
      note: "Draft metadata row for visual QA only. No backup job or restore job was executed.",
      evidenceSummaryJson: {
        scope: "local visual fixture",
        storage: "database metadata only",
        redacted: true,
      },
    }),
    backupEvidenceRecord({
      id: "backup-evidence-generated-docs-superseded",
      evidenceType: "GENERATED_DOCUMENT_BACKUP",
      status: "SUPERSEDED",
      provider: "database archive review",
      note: "Superseded local generated-document evidence for row wrapping and retention labels.",
      evidenceSummaryJson: {
        generatedDocumentCount: generatedDocuments.length,
        sampleHash: "visual-hash-sales-invoice-local-ready",
        contentsReturned: false,
      },
    }),
    backupEvidenceRecord({
      id: "backup-evidence-rpo-review-revoked",
      evidenceType: "RPO_RTO_REVIEW",
      status: "REVOKED",
      provider: "owner review checklist",
      note: "Revoked metadata row keeps destructive actions visually quiet.",
      evidenceSummaryJson: {
        rpoMinutes: null,
        rtoMinutes: null,
        reason: "No provider evidence attached.",
      },
      revokedById: "user-owner-long",
      revokedAt: fixedVisualDate,
    }),
  ];
}

function backupEvidenceRecord(overrides: Partial<ReturnType<typeof backupEvidenceRecordBase>>) {
  return {
    ...backupEvidenceRecordBase(),
    ...overrides,
    updatedAt: fixedVisualDate,
  };
}

function backupEvidenceRecordBase() {
  return {
    id: "backup-evidence-base",
    organizationId: org.id,
    scope: "ORGANIZATION",
    status: "DRAFT",
    evidenceType: "OTHER",
