...
test("local and SDK CSR evidence require exact pinned schemas and fail closed on unsafe claims", async (t) => {
  ...
  const cases = [
    ...
    [
      "SDK JDK runtime checksum verification missing",
      "sdk",
    ...
    [
      "SDK plaintext key retained through custody verification",
      "sdk",
      "plaintextKeyRemovedBeforeCustodyVerification",
      false,
    ],
    [
      "SDK staged config retained",
      "sdk",
      "sdkConfigFileRemoved",
      false,
    ],
    [
      "SDK network guard markers missing",
      "sdk",
      "networkGuardMarkersPresent",
      false,
    ],
    [
      "SDK network isolation unverified",
      "sdk",
